...
// *********************************
/**
 * Returns a TZ Date Time String.
 *
 * @param  {Object|undefined} m - The moment object to extract string from.
 * @return {string}  timeString - In 'YYYY-MM-DD HH:mm:ss ZZ' format.
 */
function getTZDTStringFromMoment (m) {
	if (m != undefined) return m.format('YYYY-MM-DD HH:mm:ss ZZ');
	else                return moment().format('YYYY-MM-DD HH:mm:ss ZZ');
}
/**
...
exports.getTZDTStringFromMoment = getTZDTStringFromMoment;
exports.getMomentFromTZDTString = getMomentFromTZDTString;
