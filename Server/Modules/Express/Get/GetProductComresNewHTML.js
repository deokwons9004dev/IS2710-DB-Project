 ...
 */
 ...
 // EXPORT
 // *********************************
module.exports = function getProductComresNewHTML (req, res) {
    // printraw('');
    print(req, '(Start) GET /product/comres/new');

    var html = fs.readFileSync(DEF.PATH.TEMPLATES.PRODUCT_COMRES_NEW, 'utf8');
